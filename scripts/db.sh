...
CREATE UNIQUE INDEX IF NOT EXISTS idx_finance_records_registration_income
  ON finance_records(reference_type, reference_id, record_type)
  WHERE reference_type = 'registration' AND record_type = 'income';
