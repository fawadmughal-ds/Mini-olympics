        ...
        <div className="relative container mx-auto px-4 py-24">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="flex justify-center gap-2 mb-8">
              <div className="w-8 h-8 rounded-full border-4 border-blue-400 opacity-80"></div>
              <div className="w-8 h-8 rounded-full border-4 border-amber-400 opacity-80 -ml-3"></div>
              <div className="w-8 h-8 rounded-full border-4 border-slate-400 opacity-80 -ml-3"></div>
              <div className="w-8 h-8 rounded-full border-4 border-emerald-400 opacity-80 -ml-3"></div>
              <div className="w-8 h-8 rounded-full border-4 border-rose-400 opacity-80 -ml-3"></div>
            </div>
            ...
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-amber-400 to-orange-500 rounded-full mb-6 shadow-lg shadow-amber-500/30">
              ...
              <span className="text-sm font-bold text-white uppercase tracking-wider">Mini Olympics 2026</span>
            </div>
        ...
        <div className="container mx-auto px-4 py-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <span className="font-bold text-lg">Mini Olympics 2026</span>
            </div>
            <p className="text-slate-400 text-sm">© {new Date().getFullYear()} FCIT Sports Society. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
